...
// RDPActivity describes the OCSF RDP Activity event class: Remote
// Desktop Protocol (RDP) Activity events report post-authentication
// remote client connections between clients and servers over the
// network.
//
// OCSF name: rdp_activity. class_uid: 4005.
type RDPActivity struct {
	...
	// Capabilities is the Capabilities. A list of RDP capabilities.
	//
	// OCSF: capabilities (type []string_t, requirement optional)
	...
	// CertificateChain is the Certificate Chain. The list of observed
	// certificates in an RDP TLS connection.
	//
	...
	// ConnectionInfo is the Connection Info. The remote desktop connection
	// details, either connection-based or connectionless.
	//
	...
	// Device is the Device. The device instigating the RDP connection.
	//
	...
	// File is the File. The file that is the target of the RDP activity.
	//
	...
	// IdentifierCookie is the Identifier Cookie. The client identifier
	// cookie during client/server exchange.
	//
	// OCSF: identifier_cookie (type string_t, requirement optional)
	...
	// ProtocolVer is the RDP Version. The Remote Desktop Protocol version.
	//
	// OCSF: protocol_ver (type string_t, requirement recommended)
	...
	// RemoteDisplay is the Remote Display. The remote display affiliated
	// with the event
	//
	// OCSF: remote_display (type display, requirement optional)
	RemoteDisplay *objects.Display `json:"remote_display,omitempty"`

	// Request is the API Request Details. The client request in an RDP
	// network connection.
	//
	// OCSF: request (type request, requirement recommended)
	Request *objects.Request `json:"request,omitempty"`

	// Response is the API Response Details. The server response in an RDP
	// network connection.
	//
	...
	// User is the User. The target user associated with the RDP activity.
	//
	// OCSF: user (type user, requirement recommended)
	User *objects.User `json:"user,omitempty"`
}

// OCSFClassUID returns the OCSF class_uid for RDP Activity (4005).
// Computed as CategoryUID*1000 + class identifier within the category.
func (RDPActivity) OCSFClassUID() int { return 4005 }

// OCSFClassName returns the OCSF class_name for RDP Activity.
func (RDPActivity) OCSFClassName() string { return "RDP Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the network category (4).
func (RDPActivity) OCSFCategoryUID() int { return 4 }
...
func (e RDPActivity) Validate() error {
	...
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 4005, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Action != "" {
		switch e.ActionID {
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 4005, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.ActivityName != "Initial Request" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.ActivityName != "Initial Response" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
			if e.ActivityName != "Connect Request" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 4:
			if e.ActivityName != "Connect Response" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 5:
			if e.ActivityName != "TLS Handshake" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 6:
		...
		case 7:
			if e.ActivityName != "Disconnect" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 8:
			if e.ActivityName != "Reconnect" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 9:
	...
	case 0, 1, 2, 3, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 4005, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Confidence != "" {
		switch e.ConfidenceID {
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 4005, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Disposition != "" {
		switch e.DispositionID {
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 4005, Field: "observation_point_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ObservationPoint != "" {
		switch e.ObservationPointID {
		case 0:
			if e.ObservationPoint != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "observation_point", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 4005, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.RiskLevel != "" {
		switch e.RiskLevelID {
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 4005, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 5, 6, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 4005, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Status != "" {
		switch e.StatusID {
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "New" {
				return &ocsf.ValidationError{ClassUID: 4005, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
