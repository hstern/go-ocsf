...
// SSHActivity describes the OCSF SSH Activity event class: SSH Activity
// events report remote client connections to a server using the Secure
// Shell (SSH) Protocol.
//
// OCSF name: ssh_activity. class_uid: 4007.
type SSHActivity struct {
	...
	// AuthType is the Authentication Type. The SSH authentication type,
	// normalized to the caption of 'auth_type_id'. In the case of 'Other',
	// it is defined by the event source.
	//
	// OCSF: auth_type (type string_t, requirement recommended)
	AuthType string `json:"auth_type,omitempty"`

	// AuthTypeID is the Authentication Type ID. The normalized identifier of
	// the SSH authentication type.
	//
	// OCSF: auth_type_id (type integer_t, requirement recommended)
	...
	// ClientHassh is the Client HASSH. The Client HASSH fingerprinting
	// object.
	//
	// OCSF: client_hassh (type hassh, requirement recommended)
	...
	// File is the File. The file that is the target of the SSH activity.
	//
	...
	// ProtocolVer is the SSH Version. The Secure Shell Protocol version.
	//
	...
	// ServerHassh is the Server HASSH. The Server HASSH fingerprinting
	// object.
	//
	// OCSF: server_hassh (type hassh, requirement recommended)
...
// OCSFClassUID returns the OCSF class_uid for SSH Activity (4007).
// Computed as CategoryUID*1000 + class identifier within the category.
func (SSHActivity) OCSFClassUID() int { return 4007 }

// OCSFClassName returns the OCSF class_name for SSH Activity.
func (SSHActivity) OCSFClassName() string { return "SSH Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the network category (4).
func (SSHActivity) OCSFCategoryUID() int { return 4 }
...
func (e SSHActivity) Validate() error {
	...
	if e.ActionID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4007, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 4007, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
		...
		case 3:
			if e.ActivityName != "Reset" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 4:
			if e.ActivityName != "Fail" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 5:
			if e.ActivityName != "Refuse" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 6:
	...
	if e.AuthTypeID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 4007, Field: "auth_type_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.AuthType != "" && e.AuthTypeID != nil {
		switch *e.AuthTypeID {
		case 0:
			if e.AuthType != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "auth_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.AuthType != "Certificate Based" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "auth_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.AuthType != "GSSAPI" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "auth_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
			if e.AuthType != "Host Based" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "auth_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 4:
			if e.AuthType != "Keyboard Interactive" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "auth_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 5:
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4007, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 4007, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.ObservationPointID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4007, Field: "observation_point_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.ObservationPoint != "" && e.ObservationPointID != nil {
		...
		case 0:
			if e.ObservationPoint != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "observation_point", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4007, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	case 0, 1, 2, 3, 4, 5, 6, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 4007, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.StatusID != nil {
		...
		case 0, 1, 2, 3, 4, 5, 6, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4007, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Status != "" && e.StatusID != nil {
		...
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "New" {
				return &ocsf.ValidationError{ClassUID: 4007, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
