...
// NTPActivity describes the OCSF NTP Activity event class: The Network
// Time Protocol (NTP) Activity events report instances of remote clients
// synchronizing their clocks with an NTP server, as observed on the
// network.
//
// OCSF name: ntp_activity. class_uid: 4013.
type NTPActivity struct {
	...
	// Delay is the Root Delay. The total round-trip delay to the reference
	// clock in milliseconds.
	//
	// OCSF: delay (type integer_t, requirement recommended)
	...
	// Dispersion is the Root Dispersion. The dispersion in the NTP protocol
	// is the estimated time error or uncertainty relative to the reference
	// clock in milliseconds.
	//
	// OCSF: dispersion (type integer_t, requirement recommended)
	...
	// Precision is the Precision. The NTP precision quantifies a clock's
	// accuracy and stability in log2 seconds, as defined in RFC-5905.
	//
	// OCSF: precision (type integer_t, requirement recommended)
	...
	// Stratum is the Stratum. The stratum level of the NTP server's time
	// source, normalized to the caption of the stratum_id value.
	//
	// OCSF: stratum (type string_t, requirement recommended)
	Stratum string `json:"stratum,omitempty"`

	// StratumID is the Stratum ID. The normalized identifier of the stratum
	// level, as defined in RFC-5905.
	//
	// OCSF: stratum_id (type integer_t, requirement recommended)
	...
	// Version is the Version. The version number of the NTP protocol.
	//
	// OCSF: version (type string_t, requirement required)
	Version string `json:"version"`
}

// OCSFClassUID returns the OCSF class_uid for NTP Activity (4013).
// Computed as CategoryUID*1000 + class identifier within the category.
func (NTPActivity) OCSFClassUID() int { return 4013 }

// OCSFClassName returns the OCSF class_name for NTP Activity.
func (NTPActivity) OCSFClassName() string { return "NTP Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the network category (4).
func (NTPActivity) OCSFCategoryUID() int { return 4 }
...
func (e NTPActivity) Validate() error {
	...
	if e.ActionID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4013, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 4013, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.ActivityName != "Symmetric Active Exchange" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.ActivityName != "Symmetric Passive Response" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
			if e.ActivityName != "Client Synchronization" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 4:
			if e.ActivityName != "Server Response" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 5:
			if e.ActivityName != "Broadcast" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 6:
			if e.ActivityName != "Control" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 7:
			if e.ActivityName != "Private Use Case" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 8:
			if e.ActivityName != "Restore" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 9:
			if e.ActivityName != "Preview" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 10:
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4013, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 4013, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.ObservationPointID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4013, Field: "observation_point_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.ObservationPoint != "" && e.ObservationPointID != nil {
		...
		case 0:
			if e.ObservationPoint != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "observation_point", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4013, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 4013, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.StatusID != nil {
		...
		case 0, 1, 2, 3, 4, 5, 6, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4013, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Status != "" && e.StatusID != nil {
		...
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "New" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.StratumID != nil {
		...
		case 0, 1, 2, 16, 17, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4013, Field: "stratum_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Stratum != "" && e.StratumID != nil {
		switch *e.StratumID {
		case 0:
			if e.Stratum != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "stratum", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Stratum != "Primary Server" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "stratum", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.Stratum != "Secondary Server" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "stratum", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 16:
			if e.Stratum != "Unsynchronized" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "stratum", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 17:
			if e.Stratum != "Reserved" {
				return &ocsf.ValidationError{ClassUID: 4013, Field: "stratum", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		}
	}
