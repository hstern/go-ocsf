...
// DNSActivity describes the OCSF DNS Activity event class: DNS Activity
// events report DNS queries and answers as seen on the network.
//
// OCSF name: dns_activity. class_uid: 4003.
type DNSActivity struct {
	...
	// Answers is the DNS Answer. The Domain Name System (DNS) answers.
	//
	// OCSF: answers (type []dns_answer, requirement recommended)
	...
	// Query is the DNS Query. The Domain Name System (DNS) query.
	//
	// OCSF: query (type dns_query, requirement recommended)
	Query *objects.DNSQuery `json:"query,omitempty"`

	// QueryTime is the Query Time. The Domain Name System (DNS) query time.
	//
	// OCSF: query_time (type timestamp_t, requirement recommended)
	...
	// Rcode is the Response Code. The DNS server response code, normalized
	// to the caption of the rcode_id value. In the case of 'Other', it is
	// defined by the event source.
	//
	// OCSF: rcode (type string_t, requirement recommended)
	Rcode string `json:"rcode,omitempty"`

	// RcodeID is the Response Code ID. The normalized identifier of the DNS
	// server response code. See RFC-6895.
	//
	// OCSF: rcode_id (type integer_t, requirement recommended)
	RcodeID *int `json:"rcode_id,omitempty"`

	// ResponseTime is the Response Time. The Domain Name System (DNS)
	// response time.
	//
	// OCSF: response_time (type timestamp_t, requirement recommended)
...
// OCSFClassUID returns the OCSF class_uid for DNS Activity (4003).
// Computed as CategoryUID*1000 + class identifier within the category.
func (DNSActivity) OCSFClassUID() int { return 4003 }

// OCSFClassName returns the OCSF class_name for DNS Activity.
func (DNSActivity) OCSFClassName() string { return "DNS Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the network category (4).
func (DNSActivity) OCSFCategoryUID() int { return 4 }

// OCSFCategoryName returns the OCSF category_name (network).
func (DNSActivity) OCSFCategoryName() string { return "network" }

// Validate checks the required-field rules for DNSActivity.
// Returns the first violation found, or nil if all required fields are present.
func (e DNSActivity) Validate() error {
	if e.Cloud == nil {
		return &ocsf.ValidationError{ClassUID: 4003, Field: "cloud", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
		return &ocsf.ValidationError{ClassUID: 4003, Field: "metadata", Rule: "required", Reason: "required field is missing"}
	}
	if len(e.Osint) == 0 {
		return &ocsf.ValidationError{ClassUID: 4003, Field: "osint", Rule: "required", Reason: "required field is missing"}
	}
	if e.ActionID != nil {
		switch *e.ActionID {
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4003, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 4003, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4003, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 4003, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.ObservationPointID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4003, Field: "observation_point_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.ObservationPoint != "" && e.ObservationPointID != nil {
		...
		case 0:
			if e.ObservationPoint != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "observation_point", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.RcodeID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 4003, Field: "rcode_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Rcode != "" && e.RcodeID != nil {
		switch *e.RcodeID {
		case 0:
			if e.Rcode != "NoError" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "rcode", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Rcode != "FormError" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "rcode", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.Rcode != "ServError" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "rcode", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
			if e.Rcode != "NXDomain" {
		...
		case 11:
			if e.Rcode != "DSOTYPENI" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "rcode", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 16:
			if e.Rcode != "BADSIG_VERS" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "rcode", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 17:
			if e.Rcode != "BADKEY" {
		...
		case 23:
			if e.Rcode != "BADCOOKIE" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "rcode", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 24:
			if e.Rcode != "Unassigned" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "rcode", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 25:
			if e.Rcode != "Reserved" {
	...
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4003, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 4003, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.StatusID != nil {
		...
		case 0, 1, 2, 3, 4, 5, 6, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 4003, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Status != "" && e.StatusID != nil {
		...
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "New" {
				return &ocsf.ValidationError{ClassUID: 4003, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
...
func init() {
	ocsf.RegisterClass(4003, func() ocsf.Event { return &DNSActivity{} })
}
