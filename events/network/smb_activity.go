...
// SMBActivity describes the OCSF SMB Activity event class: Server
// Message Block (SMB) Protocol Activity events report client/server
// connections sharing resources within the network.
//
// OCSF name: smb_activity. class_uid: 4006.
type SMBActivity struct {
	...
	// ClientDialects is the Client Dialects. The list of SMB dialects that
	// the client speaks.
	//
	// OCSF: client_dialects (type []string_t, requirement recommended)
	...
	// Command is the Command. The command name (e.g. SMB2_COMMAND_CREATE,
	...
	// DceRPC is the Distributed Computing Environment/Remote Procedure Call
	// (DCE/RPC). The DCE/RPC object describes the remote procedure call
	// system for distributed computing environments.
	//
	// OCSF: dce_rpc (type dce_rpc, requirement optional)
	...
	// Dialect is the Dialect. The negotiated protocol dialect.
	//
	// OCSF: dialect (type string_t, requirement recommended)
	...
	// File is the File. The file that is the target of the SMB activity.
	//
	...
	//
	// OCSF: open_type (type string_t, requirement recommended)
	...
	// Share is the Share. The SMB share name.
	//
	// OCSF: share (type string_t, requirement recommended)
	Share string `json:"share,omitempty"`

	// ShareType is the Share Type. The SMB share type, normalized to the
	// caption of the share_type_id value. In the case of 'Other', it is
	// defined by the event source.
	//
	// OCSF: share_type (type string_t, requirement recommended)
	ShareType string `json:"share_type,omitempty"`

	// ShareTypeID is the Share Type Id. The normalized identifier of the SMB
	// share type.
	//
	...
	// TreeUID is the Tree UID. The tree id is a unique SMB identifier which
	// represents an open connection to a share.
	//
	// OCSF: tree_uid (type string_t, requirement recommended)
...
// OCSFClassUID returns the OCSF class_uid for SMB Activity (4006).
// Computed as CategoryUID*1000 + class identifier within the category.
func (SMBActivity) OCSFClassUID() int { return 4006 }

// OCSFClassName returns the OCSF class_name for SMB Activity.
func (SMBActivity) OCSFClassName() string { return "SMB Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the network category (4).
func (SMBActivity) OCSFCategoryUID() int { return 4 }

// OCSFCategoryName returns the OCSF category_name (network).
func (SMBActivity) OCSFCategoryName() string { return "network" }

// Validate checks the required-field rules for SMBActivity.
// Returns the first violation found, or nil if all required fields are present.
func (e SMBActivity) Validate() error {
	if e.Cloud == nil {
		return &ocsf.ValidationError{ClassUID: 4006, Field: "cloud", Rule: "required", Reason: "required field is missing"}
	}
	if e.DstEndpoint == nil {
		return &ocsf.ValidationError{ClassUID: 4006, Field: "dst_endpoint", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
		return &ocsf.ValidationError{ClassUID: 4006, Field: "metadata", Rule: "required", Reason: "required field is missing"}
	}
	if len(e.Osint) == 0 {
	...
	default:
		return &ocsf.ValidationError{ClassUID: 4006, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4006, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.ActivityName != "File Supersede" {
				return &ocsf.ValidationError{ClassUID: 4006, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.ActivityName != "File Open" {
				return &ocsf.ValidationError{ClassUID: 4006, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
			if e.ActivityName != "File Create" {
				return &ocsf.ValidationError{ClassUID: 4006, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 4:
			if e.ActivityName != "File Open If" {
				return &ocsf.ValidationError{ClassUID: 4006, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 5:
			if e.ActivityName != "File Overwrite" {
				return &ocsf.ValidationError{ClassUID: 4006, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 6:
			if e.ActivityName != "File Overwrite If" {
				return &ocsf.ValidationError{ClassUID: 4006, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 7:
	...
	case 0:
	default:
		return &ocsf.ValidationError{ClassUID: 4006, Field: "category_uid", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.CategoryName != "" {
		switch e.CategoryUID {
		case 0:
			if e.CategoryName != "Uncategorized" {
				return &ocsf.ValidationError{ClassUID: 4006, Field: "category_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		}
	}
	switch e.ClassUID {
	case 0:
	default:
		return &ocsf.ValidationError{ClassUID: 4006, Field: "class_uid", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ClassName != "" {
		switch e.ClassUID {
		case 0:
			if e.ClassName != "Base Event" {
				return &ocsf.ValidationError{ClassUID: 4006, Field: "class_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		}
	}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 4006, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 4006, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
...
func init() {
	ocsf.RegisterClass(4006, func() ocsf.Event { return &SMBActivity{} })
}
