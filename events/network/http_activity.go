...
type HTTPActivity struct {
	...
	// to a requester.
	//
	// OCSF: http_response (type http_response, requirement required)
	HTTPResponse *objects.HTTPResponse `json:"http_response"`
...
func (e HTTPActivity) Validate() error {
	...
	if e.DstEndpoint == nil {
		return &ocsf.ValidationError{ClassUID: 4002, Field: "dst_endpoint", Rule: "required", Reason: "required field is missing"}
	}
	if e.HTTPRequest == nil {
		return &ocsf.ValidationError{ClassUID: 4002, Field: "http_request", Rule: "required", Reason: "required field is missing"}
	}
	if e.HTTPResponse == nil {
		return &ocsf.ValidationError{ClassUID: 4002, Field: "http_response", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
