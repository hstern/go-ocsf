...
// ProcessRemediationActivity describes the OCSF Process Remediation
// Activity event class: Process Remediation Activity events report on
// attempts at remediating processes. It follows the MITRE
// countermeasures defined by the D3FEND™ Matrix. Sub-techniques will
// include Process, such as Process Termination or Kernel-based Process
// Isolation.
//
// OCSF name: process_remediation_activity. class_uid: 7003.
type ProcessRemediationActivity struct {
	...
	// Process is the Process. The process that pertains to the remediation
	// event.
	//
...
// OCSFClassUID returns the OCSF class_uid for Process Remediation Activity (7003).
// Computed as CategoryUID*1000 + class identifier within the category.
func (ProcessRemediationActivity) OCSFClassUID() int { return 7003 }

// OCSFClassName returns the OCSF class_name for Process Remediation Activity.
func (ProcessRemediationActivity) OCSFClassName() string { return "Process Remediation Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the remediation category (7).
func (ProcessRemediationActivity) OCSFCategoryUID() int { return 7 }
...
// Validate checks the required-field rules for ProcessRemediationActivity.
...
func (e ProcessRemediationActivity) Validate() error {
	if e.Cloud == nil {
		return &ocsf.ValidationError{ClassUID: 7003, Field: "cloud", Rule: "required", Reason: "required field is missing"}
	}
	if e.CommandUID == "" {
		return &ocsf.ValidationError{ClassUID: 7003, Field: "command_uid", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
		return &ocsf.ValidationError{ClassUID: 7003, Field: "metadata", Rule: "required", Reason: "required field is missing"}
	}
	if len(e.Osint) == 0 {
		return &ocsf.ValidationError{ClassUID: 7003, Field: "osint", Rule: "required", Reason: "required field is missing"}
	}
	if e.Process == nil {
		return &ocsf.ValidationError{ClassUID: 7003, Field: "process", Rule: "required", Reason: "required field is missing"}
	}
	switch e.ActionID {
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 7003, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Action != "" {
		switch e.ActionID {
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 7003, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 7003, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	case 0, 1, 2, 3, 4, 5, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 7003, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 7003, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 7003, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Confidence != "" {
		switch e.ConfidenceID {
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 7003, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 7003, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 7003, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Disposition != "" {
		switch e.DispositionID {
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 7003, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 7003, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.RiskLevel != "" {
		switch e.RiskLevelID {
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 7003, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 7003, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 7003, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 7003, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 5, 6, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 7003, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Status != "" {
		switch e.StatusID {
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 7003, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "New" {
				return &ocsf.ValidationError{ClassUID: 7003, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
