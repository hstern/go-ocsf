...
// DroneFlightsActivity describes the OCSF Drone Flights Activity event
// class: Drone Flights Activity events report the activity of Unmanned
// Aerial Systems (UAS), their Operators, and mission-planning and
// authorization metadata as reported by the UAS platforms themselves, by
// Counter-UAS (CUAS) systems, or other remote monitoring or sensing
// infrastructure. Based on the Remote ID defined in Standard
// Specification for Remote ID and Tracking (ASTM Designation: F3411-22a)
// ASTM F3411-22a
//
// OCSF name: drone_flights_activity. class_uid: 8001.
type DroneFlightsActivity struct {
	...
	// AuthProtocol is the Authentication Type. The authentication type as
	...
	// AuthProtocolID is the Authentication Type ID. The normalized
	// identifier of the authentication type used to authorize a flight plan
	// or mission.
	//
	...
	// Classification is the Classification Type. UA Classification - Allows
	// a region to classify UAS in a regional specific manner. The format may
	...
	// Comment is the Operation Description. This optional, free-text field
	// enables the operator to describe the purpose of a flight, if so
	// desired.
	//
	...
	// System (CUAS) platform, or other unmanned systems monitoring and/or
	...
	// ProtocolName is the Remote ID Protocol. The networking protocol
	// associated with the Remote ID device or beacon. E.g. BLE, LTE, 802.11.
	//
	...
	// SrcEndpoint is the Source Endpoint. The source network endpoint of the
	// Unmanned Aerial System (UAS), Counter Unmanned Aerial System (CUAS)
	// platform, or other unmanned systems monitoring and/or sensing
	// infrastructure.
	//
	...
	// StatusID is the Operational Status ID. The normalized Operational
	...
	// transmitted from a Unmanned Aerial System (UAS) or Counter Unmanned
	// Aerial System (UAS) (CUAS) system at a given point of time. Ex:
...
// OCSFClassUID returns the OCSF class_uid for Drone Flights Activity (8001).
// Computed as CategoryUID*1000 + class identifier within the category.
func (DroneFlightsActivity) OCSFClassUID() int { return 8001 }

// OCSFClassName returns the OCSF class_name for Drone Flights Activity.
func (DroneFlightsActivity) OCSFClassName() string { return "Drone Flights Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the unmanned_systems category (8).
func (DroneFlightsActivity) OCSFCategoryUID() int { return 8 }

// OCSFCategoryName returns the OCSF category_name (unmanned_systems).
func (DroneFlightsActivity) OCSFCategoryName() string { return "unmanned_systems" }

// Validate checks the required-field rules for DroneFlightsActivity.
// Returns the first violation found, or nil if all required fields are present.
func (e DroneFlightsActivity) Validate() error {
	if e.Cloud == nil {
		return &ocsf.ValidationError{ClassUID: 8001, Field: "cloud", Rule: "required", Reason: "required field is missing"}
	}
	if e.DstEndpoint == nil {
		return &ocsf.ValidationError{ClassUID: 8001, Field: "dst_endpoint", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
		return &ocsf.ValidationError{ClassUID: 8001, Field: "metadata", Rule: "required", Reason: "required field is missing"}
	}
	if len(e.Osint) == 0 {
		return &ocsf.ValidationError{ClassUID: 8001, Field: "osint", Rule: "required", Reason: "required field is missing"}
	}
	if e.UnmannedAerialSystem == nil {
		return &ocsf.ValidationError{ClassUID: 8001, Field: "unmanned_aerial_system", Rule: "required", Reason: "required field is missing"}
	}
	...
	case 0, 1, 2, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 8001, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 8001, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.AuthProtocol != "" {
		...
		case 1:
			if e.AuthProtocol != "None" {
				return &ocsf.ValidationError{ClassUID: 8001, Field: "auth_protocol", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.AuthProtocol != "UAS ID Signature" {
				return &ocsf.ValidationError{ClassUID: 8001, Field: "auth_protocol", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
			if e.AuthProtocol != "Operator ID Signature" {
				return &ocsf.ValidationError{ClassUID: 8001, Field: "auth_protocol", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 4:
			if e.AuthProtocol != "Message Set Signature" {
				return &ocsf.ValidationError{ClassUID: 8001, Field: "auth_protocol", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 5:
			if e.AuthProtocol != "Authentication Provided by Network Remote ID" {
				return &ocsf.ValidationError{ClassUID: 8001, Field: "auth_protocol", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 6:
			if e.AuthProtocol != "Specific Authentication Method" {
				return &ocsf.ValidationError{ClassUID: 8001, Field: "auth_protocol", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 7:
			if e.AuthProtocol != "Reserved" {
				return &ocsf.ValidationError{ClassUID: 8001, Field: "auth_protocol", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 8:
			if e.AuthProtocol != "Private User" {
				return &ocsf.ValidationError{ClassUID: 8001, Field: "auth_protocol", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 9:
	...
	default:
		return &ocsf.ValidationError{ClassUID: 8001, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 8001, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.Status != "" {
		...
		case 5:
			if e.Status != "Remote ID System Failure" {
				return &ocsf.ValidationError{ClassUID: 8001, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 6:
	...
	if !(e.SrcEndpoint != nil || e.UnmannedAerialSystem != nil || e.UnmannedSystemOperator != nil || e.UnmannedSystemOperatingArea != nil) {
		return &ocsf.ValidationError{ClassUID: 8001, Field: "src_endpoint,unmanned_aerial_system,unmanned_system_operator,unmanned_system_operating_area", Rule: "constraint", Reason: "at_least_one: at least one of these fields must be set"}
	}
	return nil
}

func init() {
	ocsf.RegisterClass(8001, func() ocsf.Event { return &DroneFlightsActivity{} })
}
