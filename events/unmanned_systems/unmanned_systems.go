...
// UnmannedSystems describes the OCSF Unmanned Systems event class: The
// Unmanned Systems event is a generic event that defines a set of
// attributes available in the Unmanned Systems category.
//
// OCSF name: unmanned_systems. class_uid: 0.
...
// OCSFClassUID returns the OCSF class_uid for Unmanned Systems (0).
// Computed as CategoryUID*1000 + class identifier within the category.
func (UnmannedSystems) OCSFClassUID() int { return 0 }

// OCSFClassName returns the OCSF class_name for Unmanned Systems.
func (UnmannedSystems) OCSFClassName() string { return "Unmanned Systems" }

// OCSFCategoryUID returns the OCSF category_uid for the unmanned_systems category (8).
func (UnmannedSystems) OCSFCategoryUID() int { return 8 }

// OCSFCategoryName returns the OCSF category_name (unmanned_systems).
func (UnmannedSystems) OCSFCategoryName() string { return "unmanned_systems" }

// Validate checks the required-field rules for UnmannedSystems.
// Returns the first violation found, or nil if all required fields are present.
func (e UnmannedSystems) Validate() error {
	if e.Cloud == nil {
