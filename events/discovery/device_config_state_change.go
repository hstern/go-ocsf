...
func (e DeviceConfigStateChange) Validate() error {
	...
	if e.ActionID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5019, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	case 0, 1, 2, 3, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 5019, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5019, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 5019, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.PrevSecurityLevelID != nil {
		switch *e.PrevSecurityLevelID {
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5019, Field: "prev_security_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.PrevSecurityLevel != "" && e.PrevSecurityLevelID != nil {
		switch *e.PrevSecurityLevelID {
		case 0:
			if e.PrevSecurityLevel != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "prev_security_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.PrevSecurityLevel != "Secure" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "prev_security_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.PrevSecurityLevel != "At Risk" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "prev_security_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
			if e.PrevSecurityLevel != "Compromised" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "prev_security_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		}
	}
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5019, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.SecurityLevelID != nil {
		switch *e.SecurityLevelID {
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5019, Field: "security_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.SecurityLevel != "" && e.SecurityLevelID != nil {
		switch *e.SecurityLevelID {
		case 0:
			if e.SecurityLevel != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "security_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.SecurityLevel != "Secure" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "security_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.SecurityLevel != "At Risk" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "security_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
			if e.SecurityLevel != "Compromised" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "security_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		}
	}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 5019, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.StateID != nil {
		...
		case 0, 1, 2, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5019, Field: "state_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.State != "" && e.StateID != nil {
		switch *e.StateID {
		case 0:
			if e.State != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "state", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.State != "Disabled" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "state", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.StatusID != nil {
		...
		case 0, 1, 2, 3, 4, 5, 6, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5019, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Status != "" && e.StatusID != nil {
		...
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "New" {
				return &ocsf.ValidationError{ClassUID: 5019, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
