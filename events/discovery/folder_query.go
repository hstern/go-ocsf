...
// FolderQuery describes the OCSF Folder Query event class: Folder Query
// events report information about folders that are present on the
// system.
//
// OCSF name: folder_query. class_uid: 5008.
//
...
type FolderQuery struct {
	...
	// Folder is the Folder. The folder that is the target of the query.
	//
	// OCSF: folder (type file, requirement required)
...
// OCSFClassUID returns the OCSF class_uid for Folder Query (5008).
// Computed as CategoryUID*1000 + class identifier within the category.
func (FolderQuery) OCSFClassUID() int { return 5008 }

// OCSFClassName returns the OCSF class_name for Folder Query.
func (FolderQuery) OCSFClassName() string { return "Folder Query" }

// OCSFCategoryUID returns the OCSF category_uid for the discovery category (5).
func (FolderQuery) OCSFCategoryUID() int { return 5 }

// OCSFCategoryName returns the OCSF category_name (discovery).
func (FolderQuery) OCSFCategoryName() string { return "discovery" }

// Validate checks the required-field rules for FolderQuery.
// Returns the first violation found, or nil if all required fields are present.
func (e FolderQuery) Validate() error {
	if e.Cloud == nil {
		return &ocsf.ValidationError{ClassUID: 5008, Field: "cloud", Rule: "required", Reason: "required field is missing"}
	}
	if e.Folder == nil {
		return &ocsf.ValidationError{ClassUID: 5008, Field: "folder", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
		return &ocsf.ValidationError{ClassUID: 5008, Field: "metadata", Rule: "required", Reason: "required field is missing"}
	}
	if len(e.Osint) == 0 {
		return &ocsf.ValidationError{ClassUID: 5008, Field: "osint", Rule: "required", Reason: "required field is missing"}
	}
	if e.ActionID != nil {
		switch *e.ActionID {
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5008, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5008, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 5008, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	case 0, 1, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 5008, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5008, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5008, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5008, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 5008, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 5008, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5008, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 5, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 5008, Field: "query_result_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.QueryResult != "" {
		switch e.QueryResultID {
		case 0:
			if e.QueryResult != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5008, Field: "query_result", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5008, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 5008, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 5008, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 5008, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5008, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.StatusID != nil {
		...
		case 0, 1, 2, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5008, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Status != "" && e.StatusID != nil {
		...
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5008, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "Success" {
				return &ocsf.ValidationError{ClassUID: 5008, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
...
func init() {
	ocsf.RegisterClass(5008, func() ocsf.Event { return &FolderQuery{} })
}
