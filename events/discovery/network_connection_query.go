...
// NetworkConnectionQuery describes the OCSF Network Connection Query
// event class: Network Connection Query events report information about
// active network connections.
//
// OCSF name: network_connection_query. class_uid: 5012.
//
...
type NetworkConnectionQuery struct {
	...
	// Process is the Process. The process that owns the socket.
	//
	...
	// State is the State. The state of the socket, normalized to the caption
	// of the state_id value. In the case of 'Other', it is defined by the
	// event source.
	//
	// OCSF: state (type string_t, requirement recommended)
	State string `json:"state,omitempty"`

	// StateID is the State ID. The state of the socket.
	//
...
// OCSFClassUID returns the OCSF class_uid for Network Connection Query (5012).
// Computed as CategoryUID*1000 + class identifier within the category.
func (NetworkConnectionQuery) OCSFClassUID() int { return 5012 }

// OCSFClassName returns the OCSF class_name for Network Connection Query.
func (NetworkConnectionQuery) OCSFClassName() string { return "Network Connection Query" }

// OCSFCategoryUID returns the OCSF category_uid for the discovery category (5).
func (NetworkConnectionQuery) OCSFCategoryUID() int { return 5 }
...
func (e NetworkConnectionQuery) Validate() error {
	...
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 5012, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Action != "" {
		switch e.ActionID {
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	case 0, 1, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 5012, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 5012, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Confidence != "" {
		switch e.ConfidenceID {
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 5012, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Disposition != "" {
		switch e.DispositionID {
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 5, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 5012, Field: "query_result_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.QueryResult != "" {
		switch e.QueryResultID {
		case 0:
			if e.QueryResult != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "query_result", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 5012, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.RiskLevel != "" {
		switch e.RiskLevelID {
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 5012, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	default:
		return &ocsf.ValidationError{ClassUID: 5012, Field: "state_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.State != "" {
		switch e.StateID {
		case 0:
			if e.State != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "state", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
		...
		case 4:
			if e.State != "FIN_WAIT1" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "state", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 5:
			if e.State != "FIN_WAIT2" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "state", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 6:
	...
	case 0, 1, 2, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 5012, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Status != "" {
		switch e.StatusID {
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "Success" {
				return &ocsf.ValidationError{ClassUID: 5012, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
