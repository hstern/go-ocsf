...
// PatchState describes the OCSF Operating System Patch State event
// class: Operating System Patch State reports the installation of an OS
// patch to a device and any associated knowledgebase articles.
//
// OCSF name: patch_state. class_uid: 5004.
type PatchState struct {
	...
	//
	// OCSF: kb_article_list (type []kb_article, requirement recommended)
...
// OCSFClassUID returns the OCSF class_uid for Operating System Patch State (5004).
// Computed as CategoryUID*1000 + class identifier within the category.
func (PatchState) OCSFClassUID() int { return 5004 }

// OCSFClassName returns the OCSF class_name for Operating System Patch State.
func (PatchState) OCSFClassName() string { return "Operating System Patch State" }

// OCSFCategoryUID returns the OCSF category_uid for the discovery category (5).
func (PatchState) OCSFCategoryUID() int { return 5 }

// OCSFCategoryName returns the OCSF category_name (discovery).
func (PatchState) OCSFCategoryName() string { return "discovery" }

// Validate checks the required-field rules for PatchState.
// Returns the first violation found, or nil if all required fields are present.
func (e PatchState) Validate() error {
	if e.Cloud == nil {
		return &ocsf.ValidationError{ClassUID: 5004, Field: "cloud", Rule: "required", Reason: "required field is missing"}
	}
	if e.Device == nil {
		return &ocsf.ValidationError{ClassUID: 5004, Field: "device", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
		return &ocsf.ValidationError{ClassUID: 5004, Field: "metadata", Rule: "required", Reason: "required field is missing"}
	}
	if len(e.Osint) == 0 {
		return &ocsf.ValidationError{ClassUID: 5004, Field: "osint", Rule: "required", Reason: "required field is missing"}
	}
	if e.ActionID != nil {
		switch *e.ActionID {
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5004, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5004, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 5004, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	case 0, 1, 2, 3, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 5004, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5004, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5004, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5004, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 5004, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 5004, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5004, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5004, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 5004, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 5004, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 5004, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5004, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.StatusID != nil {
		...
		case 0, 1, 2, 3, 4, 5, 6, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 5004, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Status != "" && e.StatusID != nil {
		...
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 5004, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "New" {
				return &ocsf.ValidationError{ClassUID: 5004, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
...
func init() {
	ocsf.RegisterClass(5004, func() ocsf.Event { return &PatchState{} })
}
