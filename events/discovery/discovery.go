...
// Discovery describes the OCSF Discovery event class: The Discovery
// event is a generic event that defines a set of attributes available in
// Discovery category events. As a generic event, it could be used to log
// events that are not otherwise defined by the Discovery specific event
// classes.
//
// OCSF name: discovery. class_uid: 0.
...
// OCSFClassUID returns the OCSF class_uid for Discovery (0).
// Computed as CategoryUID*1000 + class identifier within the category.
func (Discovery) OCSFClassUID() int { return 0 }

// OCSFClassName returns the OCSF class_name for Discovery.
func (Discovery) OCSFClassName() string { return "Discovery" }

// OCSFCategoryUID returns the OCSF category_uid for the discovery category (5).
func (Discovery) OCSFCategoryUID() int { return 5 }

// OCSFCategoryName returns the OCSF category_name (discovery).
func (Discovery) OCSFCategoryName() string { return "discovery" }

// Validate checks the required-field rules for Discovery.
// Returns the first violation found, or nil if all required fields are present.
func (e Discovery) Validate() error {
	if e.Cloud == nil {
