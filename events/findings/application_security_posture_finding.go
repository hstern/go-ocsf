...
// ApplicationSecurityPostureFinding describes the OCSF Application
// Security Posture Finding event class: The Application Security Posture
// Finding event is a notification about any bug, defect, deficiency,
// exploit, vulnerability, weakness or any other issue with software and
// related systems. Application Security Posture Findings typically
// involve reporting on the greater context including compliance,
// impacted resources, remediation guidance, specific code defects,
// and/or vulnerability metadata. Application Security Posture Findings
// can be reported by Threat & Vulnerability Management (TVM) tools,
...
//
// OCSF name: application_security_posture_finding. class_uid: 2007.
type ApplicationSecurityPostureFinding struct {
	...
	// Application is the Related Application. An Application describes the
	// details for an inventoried application as reported by an Application
	// Security tool or other Developer-centric tooling. Applications can be
	// defined as Kubernetes resources, Containerized resources, or
	// application hosting-specific cloud sources such as AWS Elastic
	...
	// Compliance is the Related Compliance. Provides compliance context to
	// vulnerabilities and other weaknesses that are reported as part of an
	// Application Security or Vulnerability Management tool's built-in
	// compliance framework mapping.
	//
	// OCSF: compliance (type compliance, requirement recommended)
	...
	// remediation steps to address identified vulnerabilities or weaknesses.
	//
	// OCSF: remediation (type remediation, requirement recommended)
	Remediation *objects.Remediation `json:"remediation,omitempty"`

	// Resources is the Affected Resources. Describes details about the
	// resource/resources that are affected by the
	...
	//
	// OCSF: vulnerabilities (type []vulnerability, requirement recommended)
	Vulnerabilities []objects.Vulnerability `json:"vulnerabilities,omitempty"`
}

// OCSFClassUID returns the OCSF class_uid for Application Security Posture Finding (2007).
// Computed as CategoryUID*1000 + class identifier within the category.
func (ApplicationSecurityPostureFinding) OCSFClassUID() int { return 2007 }

// OCSFClassName returns the OCSF class_name for Application Security Posture Finding.
func (ApplicationSecurityPostureFinding) OCSFClassName() string {
	return "Application Security Posture Finding"
}

// OCSFCategoryUID returns the OCSF category_uid for the findings category (2).
func (ApplicationSecurityPostureFinding) OCSFCategoryUID() int { return 2 }

// OCSFCategoryName returns the OCSF category_name (findings).
func (ApplicationSecurityPostureFinding) OCSFCategoryName() string { return "findings" }

// Validate checks the required-field rules for ApplicationSecurityPostureFinding.
...
func (e ApplicationSecurityPostureFinding) Validate() error {
	if e.Cloud == nil {
		return &ocsf.ValidationError{ClassUID: 2007, Field: "cloud", Rule: "required", Reason: "required field is missing"}
	}
	if e.FindingInfo == nil {
		return &ocsf.ValidationError{ClassUID: 2007, Field: "finding_info", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
		return &ocsf.ValidationError{ClassUID: 2007, Field: "metadata", Rule: "required", Reason: "required field is missing"}
	}
	if len(e.Osint) == 0 {
		return &ocsf.ValidationError{ClassUID: 2007, Field: "osint", Rule: "required", Reason: "required field is missing"}
	}
	if e.ActionID != nil {
		switch *e.ActionID {
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 2007, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	case 0, 1, 2, 3, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 2007, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 2007, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 2007, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.ImpactID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 2007, Field: "impact_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Impact != "" && e.ImpactID != nil {
		...
		case 0:
			if e.Impact != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "impact", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Impact != "Low" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "impact", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.PriorityID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 2007, Field: "priority_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Priority != "" && e.PriorityID != nil {
		...
		case 0:
			if e.Priority != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "priority", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Priority != "Low" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "priority", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 2007, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 2007, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.StatusID != nil {
		...
		case 0, 1, 2, 3, 4, 5, 6, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 2007, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Status != "" && e.StatusID != nil {
		...
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "New" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.VerdictID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 2007, Field: "verdict_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Verdict != "" && e.VerdictID != nil {
		...
		case 0:
			if e.Verdict != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2007, Field: "verdict", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if !(e.Application != nil || e.Compliance != nil || e.Remediation != nil || len(e.Vulnerabilities) != 0) {
		return &ocsf.ValidationError{ClassUID: 2007, Field: "application,compliance,remediation,vulnerabilities", Rule: "constraint", Reason: "at_least_one: at least one of these fields must be set"}
	}
	return nil
}

func init() {
	ocsf.RegisterClass(2007, func() ocsf.Event { return &ApplicationSecurityPostureFinding{} })
}
