...
// Finding describes the OCSF Finding event class: The Finding event is a
// generic event that defines a set of attributes available in the
// Findings category.
//
// OCSF name: finding. class_uid: 0.
type Finding struct {
...
// OCSFClassUID returns the OCSF class_uid for Finding (0).
// Computed as CategoryUID*1000 + class identifier within the category.
func (Finding) OCSFClassUID() int { return 0 }

// OCSFClassName returns the OCSF class_name for Finding.
func (Finding) OCSFClassName() string { return "Finding" }

// OCSFCategoryUID returns the OCSF category_uid for the findings category (2).
func (Finding) OCSFCategoryUID() int { return 2 }

// OCSFCategoryName returns the OCSF category_name (findings).
func (Finding) OCSFCategoryName() string { return "findings" }

// Validate checks the required-field rules for Finding.
...
func (e Finding) Validate() error {
	...
	if e.FindingInfo == nil {
		return &ocsf.ValidationError{ClassUID: 0, Field: "finding_info", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
	...
	if e.ActionID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 0, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 0, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 0, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 0, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 0, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 0, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 0, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 0, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.ImpactID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 0, Field: "impact_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Impact != "" && e.ImpactID != nil {
		...
		case 0:
			if e.Impact != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 0, Field: "impact", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Impact != "Low" {
				return &ocsf.ValidationError{ClassUID: 0, Field: "impact", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.PriorityID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 0, Field: "priority_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Priority != "" && e.PriorityID != nil {
		...
		case 0:
			if e.Priority != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 0, Field: "priority", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Priority != "Low" {
				return &ocsf.ValidationError{ClassUID: 0, Field: "priority", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 0, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 0, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 0, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.VerdictID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 0, Field: "verdict_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Verdict != "" && e.VerdictID != nil {
		...
		case 0:
			if e.Verdict != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 0, Field: "verdict", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
