...
// incidents as a result of detections and/or analytics. Note: Incident
// Finding implicitly includes the incident profile and it should be
// added to the metadata.profiles[] array.
//
...
func (e IncidentFinding) Validate() error {
	...
	if e.ActionID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 2005, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	case 0, 1, 2, 3, 4, 5, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 2005, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 2005, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 2005, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.ImpactID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 2005, Field: "impact_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Impact != "" && e.ImpactID != nil {
		...
		case 0:
			if e.Impact != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "impact", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Impact != "Low" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "impact", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.PriorityID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 2005, Field: "priority_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Priority != "" && e.PriorityID != nil {
		...
		case 0:
			if e.Priority != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "priority", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Priority != "Low" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "priority", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 2005, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 2005, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 5, 6, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 2005, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Status != "" {
		switch e.StatusID {
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "New" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.VerdictID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 2005, Field: "verdict_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Verdict != "" && e.VerdictID != nil {
		...
		case 0:
			if e.Verdict != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 2005, Field: "verdict", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
