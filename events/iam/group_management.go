...
type GroupManagement struct {
	...
	// Subgroup is the Subgroup. A subgroup that was added to or removed from
	// the group.
	//
	// OCSF: subgroup (type group, requirement recommended)
...
func (e GroupManagement) Validate() error {
	...
	if e.ActionID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 3006, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3006, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 3006, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 3006, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3006, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 3006, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 3006, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3006, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 3006, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 3006, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 3006, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
