...
// IAM describes the OCSF Identity & Access Management event class: The
// Identity & Access Management event is a generic event that defines a
// set of attributes available in the access control events. As a generic
// event, it could be used to log events that are not otherwise defined
// by the IAM category.
//
// OCSF name: iam. class_uid: 0.
type IAM struct {
...
// OCSFClassUID returns the OCSF class_uid for Identity & Access Management (0).
// Computed as CategoryUID*1000 + class identifier within the category.
func (IAM) OCSFClassUID() int { return 0 }

// OCSFClassName returns the OCSF class_name for Identity & Access Management.
func (IAM) OCSFClassName() string { return "Identity & Access Management" }

// OCSFCategoryUID returns the OCSF category_uid for the iam category (3).
func (IAM) OCSFCategoryUID() int { return 3 }
