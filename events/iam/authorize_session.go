...
// AuthorizeSession describes the OCSF Authorize Session event class:
// Authorize Session events report privileges or groups assigned to a new
// user session, usually at login time.
//
// OCSF name: authorize_session. class_uid: 3003.
type AuthorizeSession struct {
	...
	// DstEndpoint is the Destination Endpoint. The Endpoint for which the
	// user session was targeted.
	//
	...
	// Group is the Group. Group that was assigned to the new user session.
	//
	...
	// Privileges is the Privileges. The list of sensitive privileges,
	// assigned to the new user session.
	//
	...
	// Session is the Session. The user session with the assigned privileges.
	//
	...
	// User is the User. The user to which new privileges were assigned.
	//
	// OCSF: user (type user, requirement required)
	User *objects.User `json:"user"`
}

// OCSFClassUID returns the OCSF class_uid for Authorize Session (3003).
// Computed as CategoryUID*1000 + class identifier within the category.
func (AuthorizeSession) OCSFClassUID() int { return 3003 }

// OCSFClassName returns the OCSF class_name for Authorize Session.
func (AuthorizeSession) OCSFClassName() string { return "Authorize Session" }

// OCSFCategoryUID returns the OCSF category_uid for the iam category (3).
func (AuthorizeSession) OCSFCategoryUID() int { return 3 }

// OCSFCategoryName returns the OCSF category_name (iam).
func (AuthorizeSession) OCSFCategoryName() string { return "iam" }

// Validate checks the required-field rules for AuthorizeSession.
// Returns the first violation found, or nil if all required fields are present.
func (e AuthorizeSession) Validate() error {
	if e.Cloud == nil {
		return &ocsf.ValidationError{ClassUID: 3003, Field: "cloud", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
		return &ocsf.ValidationError{ClassUID: 3003, Field: "metadata", Rule: "required", Reason: "required field is missing"}
	}
	if len(e.Osint) == 0 {
		return &ocsf.ValidationError{ClassUID: 3003, Field: "osint", Rule: "required", Reason: "required field is missing"}
	}
	if e.User == nil {
		return &ocsf.ValidationError{ClassUID: 3003, Field: "user", Rule: "required", Reason: "required field is missing"}
	}
	switch e.ActionID {
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 3003, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Action != "" {
		switch e.ActionID {
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3003, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 3003, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 3003, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3003, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
		...
		case 2:
			if e.ActivityName != "Assign Groups" {
				return &ocsf.ValidationError{ClassUID: 3003, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
	...
	case 0, 1, 2, 3, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 3003, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Confidence != "" {
		switch e.ConfidenceID {
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3003, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 3003, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 3003, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Disposition != "" {
		switch e.DispositionID {
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3003, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 3003, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.RiskLevel != "" {
		switch e.RiskLevelID {
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 3003, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 3003, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 3003, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3003, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 3003, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Status != "" {
		switch e.StatusID {
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3003, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "Success" {
				return &ocsf.ValidationError{ClassUID: 3003, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
...
func init() {
	ocsf.RegisterClass(3003, func() ocsf.Event { return &AuthorizeSession{} })
}
