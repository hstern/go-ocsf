...
// AccountChange describes the OCSF Account Change event class: Account
// Change events report when specific user account management tasks are
// performed, such as a user/role being created, changed, deleted,
// renamed, disabled, enabled, locked out or unlocked.
//
// OCSF name: account_change. class_uid: 3001.
type AccountChange struct {
	...
	// AuthFactors is the Authentication Factors. Details about the
	// authentication factors associated with the MFA Factor Enable/Disable
	// activities.
	//
	...
	// Policies is the Policies. Details about the IAM policies associated
	// with the Attach/Detach Policy activities.
	//
	// OCSF: policies (type []policy, requirement optional)
	Policies []objects.Policy `json:"policies,omitempty"`

	// Policy is the Policy. Details about the IAM policy associated to the
	// Attach/Detach Policy activities.
	//
	// OCSF: policy (type policy, requirement optional)
	//
	// Deprecated: Use the <code>policies</code> attribute instead.
	...
	// User is the User. The user that was a target of an activity.
	//
	// OCSF: user (type user, requirement required)
	User *objects.User `json:"user"`

	// UserResult is the User Result. The result of the user account change.
	// It should contain the new values of the changed attributes.
	//
	// OCSF: user_result (type user, requirement recommended)
	UserResult *objects.User `json:"user_result,omitempty"`
}

// OCSFClassUID returns the OCSF class_uid for Account Change (3001).
// Computed as CategoryUID*1000 + class identifier within the category.
func (AccountChange) OCSFClassUID() int { return 3001 }

// OCSFClassName returns the OCSF class_name for Account Change.
func (AccountChange) OCSFClassName() string { return "Account Change" }

// OCSFCategoryUID returns the OCSF category_uid for the iam category (3).
func (AccountChange) OCSFCategoryUID() int { return 3 }

// OCSFCategoryName returns the OCSF category_name (iam).
func (AccountChange) OCSFCategoryName() string { return "iam" }

// Validate checks the required-field rules for AccountChange.
// Returns the first violation found, or nil if all required fields are present.
func (e AccountChange) Validate() error {
	if e.Cloud == nil {
		return &ocsf.ValidationError{ClassUID: 3001, Field: "cloud", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
		return &ocsf.ValidationError{ClassUID: 3001, Field: "metadata", Rule: "required", Reason: "required field is missing"}
	}
	if len(e.Osint) == 0 {
		return &ocsf.ValidationError{ClassUID: 3001, Field: "osint", Rule: "required", Reason: "required field is missing"}
	}
	if e.User == nil {
		return &ocsf.ValidationError{ClassUID: 3001, Field: "user", Rule: "required", Reason: "required field is missing"}
	}
	if e.ActionID != nil {
		switch *e.ActionID {
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 3001, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3001, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 3001, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 3001, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3001, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
		...
		case 3:
			if e.ActivityName != "Password Change" {
				return &ocsf.ValidationError{ClassUID: 3001, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 4:
			if e.ActivityName != "Password Reset" {
				return &ocsf.ValidationError{ClassUID: 3001, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 5:
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 3001, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3001, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 3001, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 3001, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3001, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 3001, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 3001, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 3001, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 3001, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3001, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.StatusID != nil {
		...
		case 0, 1, 2, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 3001, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Status != "" && e.StatusID != nil {
		...
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 3001, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "Success" {
				return &ocsf.ValidationError{ClassUID: 3001, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
...
func init() {
	ocsf.RegisterClass(3001, func() ocsf.Event { return &AccountChange{} })
}
