...
// EventLogActvity describes the OCSF Event Log Activity event class:
// Event Log Activity events report actions pertaining to the system's
// event logging service(s), such as disabling logging or clearing the
// log data.
//
// OCSF name: event_log_actvity. class_uid: 1008.
type EventLogActvity struct {
	...
	// Actor is the Actor. The actor that performed the activity.
	//
	...
	// Device is the Device. The device that reported the event.
	//
	...
	// DstEndpoint is the Destination Endpoint. The targeted endpoint for the
	// event log activity.
	//
	...
	// File is the File. The file targeted by the activity. Example:
	// /var/log/audit.log
	//
	...
	// LogName is the Log Name. The name of the event log targeted by the
	// activity. Example: Windows Security.
	//
	...
	// service targeted by the activity.Example:
	...
	// LogType is the Log Type. The log type, normalized to the caption of
	// the log_type_id value. In the case of 'Other', it is defined by the
	// event source.
	//
	// OCSF: log_type (type string_t, requirement recommended)
	LogType string `json:"log_type,omitempty"`

	// LogTypeID is the Log Type ID. The normalized log type identifier.
	//
	// OCSF: log_type_id (type integer_t, requirement recommended)
	...
	// SrcEndpoint is the Source Endpoint. The source endpoint for the event
	// log activity.
	//
	...
	// the event source.Example: 0, 8, or 21 for Windows ClearEventLog.
	//
	...
	// additional information about the event outcome.Example: Success,
	// Privilege Missing, or Invalid Parameter for Windows ClearEventLog.
	//
...
// OCSFClassUID returns the OCSF class_uid for Event Log Activity (1008).
// Computed as CategoryUID*1000 + class identifier within the category.
func (EventLogActvity) OCSFClassUID() int { return 1008 }

// OCSFClassName returns the OCSF class_name for Event Log Activity.
func (EventLogActvity) OCSFClassName() string { return "Event Log Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the system category (1).
func (EventLogActvity) OCSFCategoryUID() int { return 1 }

// OCSFCategoryName returns the OCSF category_name (system).
func (EventLogActvity) OCSFCategoryName() string { return "system" }

// Validate checks the required-field rules for EventLogActvity.
...
func (e EventLogActvity) Validate() error {
	...
	if e.ActionID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 1008, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 1008, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.ActivityName != "Clear" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
		...
		case 4:
			if e.ActivityName != "Archive" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 5:
			if e.ActivityName != "Rotate" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 6:
			if e.ActivityName != "Start" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 7:
			if e.ActivityName != "Stop" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 8:
			if e.ActivityName != "Restart" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 9:
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 1008, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 1008, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.LogTypeID != nil {
		...
		case 0, 1, 2, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 1008, Field: "log_type_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.LogType != "" && e.LogTypeID != nil {
		switch *e.LogTypeID {
		case 0:
			if e.LogType != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "log_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.LogType != "OS" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "log_type", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 1008, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 1008, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.StatusID != nil {
		...
		case 0, 1, 2, 3, 4, 5, 6, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 1008, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Status != "" && e.StatusID != nil {
		...
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "New" {
				return &ocsf.ValidationError{ClassUID: 1008, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if !(e.LogName != "" || e.LogProvider != "" || e.LogType != "" || e.LogTypeID != nil) {
...
func init() {
	ocsf.RegisterClass(1008, func() ocsf.Event { return &EventLogActvity{} })
}
