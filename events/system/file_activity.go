...
// FileActivity describes the OCSF File System Activity event class: File
// System Activity events report when a process performs an action on a
// file or folder.
//
// OCSF name: file_activity. class_uid: 1001.
type FileActivity struct {
	...
	// Actor is the Actor. The actor that performed the activity on the file
	// object
	//
	...
	// Component is the Component. The name or relative pathname of a
	// sub-component of the data object, if applicable. For example:
	// attachment.doc, attachment.zip/bad.doc, or
	// part.mime/part.cab/part.uue/part.doc.
	//
	// OCSF: component (type string_t, requirement recommended)
	...
	// ConnectionUID is the Connection Identifier. The network connection
	// identifier.
	//
	// OCSF: connection_uid (type string_t, requirement optional)
	...
	// CreateMask is the Create Mask. The original Windows mask that is
	// required to create the object.
	//
	// OCSF: create_mask (type string_t, requirement recommended)
	...
	// FileDiff is the File Diff. File content differences used for change
	// detection. For example, a common use case is to identify itemized
	// changes within INI or configuration/property setting values.
	//
	// OCSF: file_diff (type string_t, requirement recommended)
	...
	//
	// OCSF: file_result (type file, requirement recommended)
...
// OCSFClassUID returns the OCSF class_uid for File System Activity (1001).
// Computed as CategoryUID*1000 + class identifier within the category.
func (FileActivity) OCSFClassUID() int { return 1001 }

// OCSFClassName returns the OCSF class_name for File System Activity.
func (FileActivity) OCSFClassName() string { return "File System Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the system category (1).
func (FileActivity) OCSFCategoryUID() int { return 1 }

// OCSFCategoryName returns the OCSF category_name (system).
func (FileActivity) OCSFCategoryName() string { return "system" }

// Validate checks the required-field rules for FileActivity.
// Returns the first violation found, or nil if all required fields are present.
func (e FileActivity) Validate() error {
	if e.Actor == nil {
		return &ocsf.ValidationError{ClassUID: 1001, Field: "actor", Rule: "required", Reason: "required field is missing"}
	}
	if e.Cloud == nil {
		return &ocsf.ValidationError{ClassUID: 1001, Field: "cloud", Rule: "required", Reason: "required field is missing"}
	}
	if e.Device == nil {
		return &ocsf.ValidationError{ClassUID: 1001, Field: "device", Rule: "required", Reason: "required field is missing"}
	}
	if e.File == nil {
		return &ocsf.ValidationError{ClassUID: 1001, Field: "file", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
		return &ocsf.ValidationError{ClassUID: 1001, Field: "metadata", Rule: "required", Reason: "required field is missing"}
	}
	if len(e.Osint) == 0 {
		return &ocsf.ValidationError{ClassUID: 1001, Field: "osint", Rule: "required", Reason: "required field is missing"}
	}
	switch e.ActionID {
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 1001, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Action != "" {
		switch e.ActionID {
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1001, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 1001, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 1001, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1001, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 1001, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Confidence != "" {
		switch e.ConfidenceID {
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1001, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 1001, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 1001, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Disposition != "" {
		switch e.DispositionID {
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1001, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 1001, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.RiskLevel != "" {
		switch e.RiskLevelID {
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 1001, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 1001, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 1001, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1001, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 5, 6, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 1001, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Status != "" {
		switch e.StatusID {
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1001, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "New" {
				return &ocsf.ValidationError{ClassUID: 1001, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
...
func init() {
	ocsf.RegisterClass(1001, func() ocsf.Event { return &FileActivity{} })
}
