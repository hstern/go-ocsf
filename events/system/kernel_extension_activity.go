...
// KernelExtensionActivity describes the OCSF Kernel Extension Activity
// event class: Kernel Extension events report when a driver/extension is
// loaded or unloaded into the kernel
//
// OCSF name: kernel_extension_activity. class_uid: 1002.
type KernelExtensionActivity struct {
	...
	// Actor is the Actor. The actor process that loaded or unloaded the
	// driver/extension.
	//
	...
	// Driver is the Kernel Driver. The driver that was loaded/unloaded into
	// the kernel
	//
	// OCSF: driver (type kernel_driver, requirement required)
...
// OCSFClassUID returns the OCSF class_uid for Kernel Extension Activity (1002).
// Computed as CategoryUID*1000 + class identifier within the category.
func (KernelExtensionActivity) OCSFClassUID() int { return 1002 }

// OCSFClassName returns the OCSF class_name for Kernel Extension Activity.
func (KernelExtensionActivity) OCSFClassName() string { return "Kernel Extension Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the system category (1).
func (KernelExtensionActivity) OCSFCategoryUID() int { return 1 }

// OCSFCategoryName returns the OCSF category_name (system).
func (KernelExtensionActivity) OCSFCategoryName() string { return "system" }

// Validate checks the required-field rules for KernelExtensionActivity.
// Returns the first violation found, or nil if all required fields are present.
func (e KernelExtensionActivity) Validate() error {
	if e.Actor == nil {
		return &ocsf.ValidationError{ClassUID: 1002, Field: "actor", Rule: "required", Reason: "required field is missing"}
	}
	if e.Cloud == nil {
		return &ocsf.ValidationError{ClassUID: 1002, Field: "cloud", Rule: "required", Reason: "required field is missing"}
	}
	if e.Device == nil {
		return &ocsf.ValidationError{ClassUID: 1002, Field: "device", Rule: "required", Reason: "required field is missing"}
	}
	if e.Driver == nil {
		return &ocsf.ValidationError{ClassUID: 1002, Field: "driver", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
		return &ocsf.ValidationError{ClassUID: 1002, Field: "metadata", Rule: "required", Reason: "required field is missing"}
	}
	if len(e.Osint) == 0 {
		return &ocsf.ValidationError{ClassUID: 1002, Field: "osint", Rule: "required", Reason: "required field is missing"}
	}
	switch e.ActionID {
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 1002, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Action != "" {
		switch e.ActionID {
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1002, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 1002, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 1002, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1002, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.ActivityName != "Load" {
				return &ocsf.ValidationError{ClassUID: 1002, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.ActivityName != "Unload" {
				return &ocsf.ValidationError{ClassUID: 1002, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
	...
	case 0, 1, 2, 3, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 1002, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Confidence != "" {
		switch e.ConfidenceID {
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1002, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 1002, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 1002, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Disposition != "" {
		switch e.DispositionID {
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1002, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 1002, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.RiskLevel != "" {
		switch e.RiskLevelID {
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 1002, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 1002, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 1002, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1002, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 5, 6, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 1002, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Status != "" {
		switch e.StatusID {
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1002, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "New" {
				return &ocsf.ValidationError{ClassUID: 1002, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
...
func init() {
	ocsf.RegisterClass(1002, func() ocsf.Event { return &KernelExtensionActivity{} })
}
