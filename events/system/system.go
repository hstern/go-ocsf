...
// System describes the OCSF System Activity event class: The System
// Activity event is a generic event that defines a set of attributes
// available in the system activity events. As a generic event, it could
// be used to log events that are not otherwise defined by the System
// Activity category.
//
// OCSF name: system. class_uid: 0.
type System struct {
...
// OCSFClassUID returns the OCSF class_uid for System Activity (0).
// Computed as CategoryUID*1000 + class identifier within the category.
func (System) OCSFClassUID() int { return 0 }

// OCSFClassName returns the OCSF class_name for System Activity.
func (System) OCSFClassName() string { return "System Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the system category (1).
func (System) OCSFCategoryUID() int { return 1 }
