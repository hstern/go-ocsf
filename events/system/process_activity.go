...
// ProcessActivity describes the OCSF Process Activity event class:
// Process Activity events report when a process launches, injects, opens
// or terminates another process, successful or otherwise.
//
// OCSF name: process_activity. class_uid: 1007.
type ProcessActivity struct {
	...
	// target process. For example, the process that started a new process or
	...
	// granted to the process in a platform-native format.
	//
	// OCSF: actual_permissions (type integer_t, requirement recommended)
	ActualPermissions *int `json:"actual_permissions,omitempty"`

	// AiModel is the AI Model. The AI Model object describes the
	// characteristics of an AI/ML model. Examples include language models
	// like GPT-4, embedding models like text-embedding-ada-002, and computer
	// vision models like CLIP.
	//
	// OCSF: ai_model (type ai_model, requirement recommended)
	AiModel *objects.AiModel `json:"ai_model,omitempty"`
	...
	// ExitCode is the Exit Code. The exit code reported by a process when it
	// terminates. The convention is that zero indicates success and any
	// non-zero exit code indicates that some error occurred.
	//
	// OCSF: exit_code (type integer_t, requirement recommended)
	...
	// InjectionType is the Injection Type. The process injection method,
	// normalized to the caption of the injection_type_id value. In the case
	// of 'Other', it is defined by the event source.
	//
	// OCSF: injection_type (type string_t, requirement recommended)
	InjectionType string `json:"injection_type,omitempty"`

	// InjectionTypeID is the Injection Type ID. The normalized identifier of
	// the process injection method.
	//
	// OCSF: injection_type_id (type integer_t, requirement recommended)
	...
	// LaunchType is the Launch Type. The specific type of Launch activity,
	// normalized to the caption of the launch_type_id value. In the case of
	// Other it is defined by the event source.
	//
	// OCSF: launch_type (type string_t, requirement recommended)
	LaunchType string `json:"launch_type,omitempty"`

	// LaunchTypeID is the Launch Type ID. The normalized identifier for the
	// specific type of Launch activity.
	//
	// OCSF: launch_type_id (type integer_t, requirement recommended)
	...
	// MessageContext is the Message Context. Communication context for AI
	// system interactions including protocols, roles, clients, and session
	// information for MCP and other AI communication systems.
	//
	// OCSF: message_context (type message_context, requirement optional)
	MessageContext *objects.MessageContext `json:"message_context,omitempty"`
	...
	// Module is the Module. The module that was injected by the actor
	// process.
	//
	...
	// Process is the Process. The process that was launched, injected into,
	...
	// mask that was requested by the process.
	//
...
// OCSFClassUID returns the OCSF class_uid for Process Activity (1007).
// Computed as CategoryUID*1000 + class identifier within the category.
func (ProcessActivity) OCSFClassUID() int { return 1007 }

// OCSFClassName returns the OCSF class_name for Process Activity.
func (ProcessActivity) OCSFClassName() string { return "Process Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the system category (1).
func (ProcessActivity) OCSFCategoryUID() int { return 1 }
...
func (e ProcessActivity) Validate() error {
	...
	if e.ActionID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 1007, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 1007, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.ActivityName != "Launch" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.ActivityName != "Terminate" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
		...
		case 4:
			if e.ActivityName != "Inject" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 5:
			if e.ActivityName != "Set User ID" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 6:
			if e.ActivityName != "Enable DEP" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 7:
		...
		case 8:
			if e.ActivityName != "Write" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 9:
			if e.ActivityName != "Map View" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 10:
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 1007, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 1007, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.InjectionTypeID != nil {
		switch *e.InjectionTypeID {
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 1007, Field: "injection_type_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.InjectionType != "" && e.InjectionTypeID != nil {
		switch *e.InjectionTypeID {
		case 0:
			if e.InjectionType != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "injection_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.InjectionType != "Remote Thread" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "injection_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.InjectionType != "Load Library" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "injection_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
			if e.InjectionType != "Queue APC" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "injection_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		}
	}
	if e.LaunchTypeID != nil {
		switch *e.LaunchTypeID {
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 1007, Field: "launch_type_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.LaunchType != "" && e.LaunchTypeID != nil {
		switch *e.LaunchTypeID {
		case 0:
			if e.LaunchType != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "launch_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.LaunchType != "Spawn" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "launch_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.LaunchType != "Fork" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "launch_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
			if e.LaunchType != "Exec" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "launch_type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		}
	}
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 1007, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 1007, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.StatusID != nil {
		...
		case 0, 1, 2, 3, 4, 5, 6, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 1007, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Status != "" && e.StatusID != nil {
		...
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "New" {
				return &ocsf.ValidationError{ClassUID: 1007, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
