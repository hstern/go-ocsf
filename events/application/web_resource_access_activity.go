...
// WebResourceAccessActivity describes the OCSF Web Resource Access
// Activity event class: Web Resource Access Activity events describe
// successful/failed attempts to access a web resource over HTTP.
//
// OCSF name: web_resource_access_activity. class_uid: 6004.
//
// Deprecated: Use the <code>Web Resources Activity</code> class with the <code>Security Control</code> and/or <code>Network Proxy</code> profile instead.
type WebResourceAccessActivity struct {
	...
	// request.
	//
	// OCSF: http_request (type http_request, requirement required)
	...
	// Proxy is the Proxy. Details about the proxy service, if available.
	//
	// OCSF: proxy (type network_proxy, requirement optional)
	...
	// TLS is the TLS. The Transport Layer Security (TLS) attributes, if
	// available.
	//
	...
	// WebResources is the Web Resources. Details about the resource that is
	// the target of the activity.
	//
	// OCSF: web_resources (type []web_resource, requirement required)
	WebResources []objects.WebResource `json:"web_resources"`
}

// OCSFClassUID returns the OCSF class_uid for Web Resource Access Activity (6004).
// Computed as CategoryUID*1000 + class identifier within the category.
func (WebResourceAccessActivity) OCSFClassUID() int { return 6004 }

// OCSFClassName returns the OCSF class_name for Web Resource Access Activity.
func (WebResourceAccessActivity) OCSFClassName() string { return "Web Resource Access Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the application category (6).
func (WebResourceAccessActivity) OCSFCategoryUID() int { return 6 }

// OCSFCategoryName returns the OCSF category_name (application).
func (WebResourceAccessActivity) OCSFCategoryName() string { return "application" }

// Validate checks the required-field rules for WebResourceAccessActivity.
...
func (e WebResourceAccessActivity) Validate() error {
	if e.Cloud == nil {
		return &ocsf.ValidationError{ClassUID: 6004, Field: "cloud", Rule: "required", Reason: "required field is missing"}
	}
	if e.HTTPRequest == nil {
		return &ocsf.ValidationError{ClassUID: 6004, Field: "http_request", Rule: "required", Reason: "required field is missing"}
	}
	if e.Metadata == nil {
		return &ocsf.ValidationError{ClassUID: 6004, Field: "metadata", Rule: "required", Reason: "required field is missing"}
	}
	if len(e.Osint) == 0 {
		return &ocsf.ValidationError{ClassUID: 6004, Field: "osint", Rule: "required", Reason: "required field is missing"}
	}
	if len(e.WebResources) == 0 {
		return &ocsf.ValidationError{ClassUID: 6004, Field: "web_resources", Rule: "required", Reason: "required field is missing"}
	}
	switch e.ActionID {
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 6004, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Action != "" {
		switch e.ActionID {
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 6004, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.ActivityName != "Access Grant" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 2:
			if e.ActivityName != "Access Deny" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 3:
			if e.ActivityName != "Access Revoke" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 4:
			if e.ActivityName != "Access Error" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 5:
	...
	case 0, 1, 2, 3, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 6004, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Confidence != "" {
		switch e.ConfidenceID {
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 6004, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Disposition != "" {
		switch e.DispositionID {
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 6004, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.RiskLevel != "" {
		switch e.RiskLevelID {
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 6004, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 6004, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Status != "" {
		switch e.StatusID {
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "Success" {
				return &ocsf.ValidationError{ClassUID: 6004, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
...
func init() {
	ocsf.RegisterClass(6004, func() ocsf.Event { return &WebResourceAccessActivity{} })
}
