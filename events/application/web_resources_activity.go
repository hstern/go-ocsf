...
// WebResourcesActivity describes the OCSF Web Resources Activity event
// class: Web Resources Activity events describe actions executed on a
// set of Web Resources.
//
// OCSF name: web_resources_activity. class_uid: 6001.
type WebResourcesActivity struct {
	...
	// DstEndpoint is the Destination Endpoint. Details about server
	// providing the web resources.
	//
	...
	// SrcEndpoint is the Source Endpoint. Details about the endpoint from
	...
	// WebResources is the Web Resources. Describes details about web
	// resources that were affected by an activity/event.
	//
	// OCSF: web_resources (type []web_resource, requirement required)
	WebResources []objects.WebResource `json:"web_resources"`

	// WebResourcesResult is the Web Resources Result. The results of the
	// activity on web resources. It should contain the new values of the
	// changed attributes of the web resources.
	//
	// OCSF: web_resources_result (type []web_resource, requirement recommended)
	WebResourcesResult []objects.WebResource `json:"web_resources_result,omitempty"`
}

// OCSFClassUID returns the OCSF class_uid for Web Resources Activity (6001).
// Computed as CategoryUID*1000 + class identifier within the category.
func (WebResourcesActivity) OCSFClassUID() int { return 6001 }

// OCSFClassName returns the OCSF class_name for Web Resources Activity.
func (WebResourcesActivity) OCSFClassName() string { return "Web Resources Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the application category (6).
func (WebResourcesActivity) OCSFCategoryUID() int { return 6 }
...
func (e WebResourcesActivity) Validate() error {
	...
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 6001, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Action != "" {
		switch e.ActionID {
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6001, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 6001, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 6001, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6001, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 6001, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Confidence != "" {
		switch e.ConfidenceID {
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6001, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 6001, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 6001, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Disposition != "" {
		switch e.DispositionID {
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6001, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 3, 4, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 6001, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.RiskLevel != "" {
		switch e.RiskLevelID {
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 6001, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 6001, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 6001, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6001, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	case 0, 1, 2, 99:
	default:
		return &ocsf.ValidationError{ClassUID: 6001, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Status != "" {
		switch e.StatusID {
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6001, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "Success" {
				return &ocsf.ValidationError{ClassUID: 6001, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
