...
// DatastoreActivity describes the OCSF Datastore Activity event class:
// Datastore events describe general activities (Read, Update, Query,
// Delete, etc.) which affect datastores or data within those datastores,
// e.g. (AWS RDS, AWS S3).
//
// OCSF name: datastore_activity. class_uid: 6005.
type DatastoreActivity struct {
	...
	// Database is the Database. The database object is used for databases
	// which are typically datastore services that contain an organized
	...
	// Databucket is the Databucket. The data bucket object is a basic
	// container that holds data, typically organized through the use of data
	// partitions.
	//
	...
	// DstEndpoint is the Destination Endpoint. Details about the endpoint
	// hosting the datastore application or service.
	//
	...
	// QueryInfo is the Query Info. The query info object holds information
	// related to data access within a datastore. To access, manipulate,
	// delete, or retrieve data from a datastore, a database query must be
	...
	// Table is the Table. The table object represents a table within a
	// structured relational database or datastore, which contains columns
	// and rows of data that are able to be create, updated, deleted and
	// queried.
	//
	...
	// Type is the Datastore Type. The datastore resource type (e.g.
	// database, datastore, or table).
	//
	// OCSF: type (type string_t, requirement optional)
	Type string `json:"type,omitempty"`

	// TypeID is the Datastore Type ID. The normalized datastore resource
	// type identifier.
	//
...
// OCSFClassUID returns the OCSF class_uid for Datastore Activity (6005).
// Computed as CategoryUID*1000 + class identifier within the category.
func (DatastoreActivity) OCSFClassUID() int { return 6005 }

// OCSFClassName returns the OCSF class_name for Datastore Activity.
func (DatastoreActivity) OCSFClassName() string { return "Datastore Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the application category (6).
func (DatastoreActivity) OCSFCategoryUID() int { return 6 }
...
func (e DatastoreActivity) Validate() error {
	...
	if e.ActionID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 6005, Field: "action_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Action != "" && e.ActionID != nil {
		...
		case 0:
			if e.Action != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6005, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Action != "Allowed" {
				return &ocsf.ValidationError{ClassUID: 6005, Field: "action", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 6005, Field: "activity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.ActivityName != "" {
		switch e.ActivityID {
		case 0:
			if e.ActivityName != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6005, Field: "activity_name", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.ConfidenceID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 6005, Field: "confidence_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Confidence != "" && e.ConfidenceID != nil {
		...
		case 0:
			if e.Confidence != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6005, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Confidence != "Low" {
				return &ocsf.ValidationError{ClassUID: 6005, Field: "confidence", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.DispositionID != nil {
		...
		default:
			return &ocsf.ValidationError{ClassUID: 6005, Field: "disposition_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Disposition != "" && e.DispositionID != nil {
		...
		case 0:
			if e.Disposition != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6005, Field: "disposition", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.RiskLevelID != nil {
		...
		case 0, 1, 2, 3, 4, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 6005, Field: "risk_level_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.RiskLevel != "" && e.RiskLevelID != nil {
		...
		case 0:
			if e.RiskLevel != "Info" {
				return &ocsf.ValidationError{ClassUID: 6005, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.RiskLevel != "Low" {
				return &ocsf.ValidationError{ClassUID: 6005, Field: "risk_level", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	default:
		return &ocsf.ValidationError{ClassUID: 6005, Field: "severity_id", Rule: "enum", Reason: "value outside the schema's enum range"}
	}
	if e.Severity != "" {
		switch e.SeverityID {
		case 0:
			if e.Severity != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6005, Field: "severity", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
	...
	if e.StatusID != nil {
		...
		case 0, 1, 2, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 6005, Field: "status_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Status != "" && e.StatusID != nil {
		...
		case 0:
			if e.Status != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6005, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Status != "Success" {
				return &ocsf.ValidationError{ClassUID: 6005, Field: "status", Rule: "enum", Reason: "sibling does not match enum caption"}
	...
	if e.TypeID != nil {
		...
		case 0, 1, 2, 3, 99:
		default:
			return &ocsf.ValidationError{ClassUID: 6005, Field: "type_id", Rule: "enum", Reason: "value outside the schema's enum range"}
		}
	}
	if e.Type != "" && e.TypeID != nil {
		switch *e.TypeID {
		case 0:
			if e.Type != "Unknown" {
				return &ocsf.ValidationError{ClassUID: 6005, Field: "type", Rule: "enum", Reason: "sibling does not match enum caption"}
			}
		case 1:
			if e.Type != "Database" {
				return &ocsf.ValidationError{ClassUID: 6005, Field: "type", Rule: "enum", Reason: "sibling does not match enum caption"}
