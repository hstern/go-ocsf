...
// Application describes the OCSF Application Activity event class:
// Application Activity
//
// OCSF name: application. class_uid: 0.
...
// OCSFClassUID returns the OCSF class_uid for Application Activity (0).
// Computed as CategoryUID*1000 + class identifier within the category.
func (Application) OCSFClassUID() int { return 0 }

// OCSFClassName returns the OCSF class_name for Application Activity.
func (Application) OCSFClassName() string { return "Application Activity" }

// OCSFCategoryUID returns the OCSF category_uid for the application category (6).
func (Application) OCSFCategoryUID() int { return 6 }
