...
// NetworkEndpoint describes the OCSF Network Endpoint object: The
// Network Endpoint object describes characteristics of a network
// endpoint. These can be a source or destination of a network
// connection.
//
// OCSF name: network_endpoint.
