...
// UnmannedSystemOperatingArea describes the OCSF Unmanned System
// Operating Area object: The Unmanned System Operating Area object
// describes details about a precise area of operations for a UAS flight
// or mission.
//
// OCSF name: unmanned_system_operating_area.
type UnmannedSystemOperatingArea struct {
	...
	// AltitudeCeiling is the Altitude Ceiling. Maximum altitude (WGS-84 HAE)
	// for a group or an Intent-Based Network Participant. Measured in
	// meters. Special Values: Invalid, No Value, or Unknown: -1000 m.
	//
	// OCSF: altitude_ceiling (type string_t, requirement optional)
	AltitudeCeiling string `json:"altitude_ceiling,omitempty"`

	// AltitudeFloor is the Altitude Floor. Minimum altitude (WGS-84 HAE) for
	// a group or an Intent-Based Network Participant. Measured in meters.
	// Special Values: Invalid, No Value, or Unknown: -1000 m.
	//
	// OCSF: altitude_floor (type string_t, requirement optional)
	...
	// EndTime is the End Time. The date and time at which a group or an
	// Intent-Based Network Participant operation ends. (This field is only
	...
	// group or Intent-Based Network Participant operation is taking place.
	// (This field is only applicable to Network Remote ID.)
	//
	// OCSF: locations (type []location, requirement recommended)
	...
	// Radius is the Operating Area Radius. Farthest horizontal distance from
	// the reported location at which any UA in a group may be located
	// (meters). Also allows defining the area where an Intent-Based Network
	// Participant operation is taking place. Default: 0 m.
	//
	// OCSF: radius (type string_t, requirement optional)
	...
	// StartTime is the Start Time. The date and time at which a group or an
	// Intent-Based Network Participant operation starts. (This field is only
	// applicable to Network Remote ID.)
	//
